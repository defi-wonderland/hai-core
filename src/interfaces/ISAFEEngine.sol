...
interface ISAFEEngine is IAuthorizable, IModifiable, IDisableable {
   ...
   * @param  _cType Bytes32 representation of the collateral type
   * @return  _safeEngineCParams the active SAFEEngineCollateralParams for the collateral type
   */
   ...
   * @param  _cType Bytes32 representation of the collateral type
   * @return  _safeEngineCData the active SAFEEngineCollateralData for the collateral type
   */
   ...
   * @return _safeData the SAFE data for the specified collateral type of the specified safe.
   */
